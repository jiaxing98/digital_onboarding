...
//
// Map<String, ({int index, Widget page})> get newRegisterMap => {
...
//         ),
//       ),
//       RegistrationPageName.confirmPhoneNumber: (
//         index: 1,
//         page: UIProvider<SimPackageVM>(
//           viewModel: viewModels.get<SimPackageVM>(),
//           child: (_) => const ConfirmMobileNumberPage(),
//         ),
//       ),
